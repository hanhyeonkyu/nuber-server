...
class User extends BaseEntity {
    ...
    @Column({ type: "text", nullable: true }) @IsEmail() email: string | null
    ...
    @Column({ type: "boolean", default: false }) verifiedPhoneNumber
    ...
    @OneToMany(type => Place, place => place.user) places: Place[]
